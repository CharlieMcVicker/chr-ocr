...
symlink_path = "training_data_v2/line_crops"
...
for item in manifest.values():
    ...
    dst_path = os.path.join("training_data_v2/line_crops", filename)
...
print(f"Moved {moved_count} files to training_data_v2/line_crops.")
