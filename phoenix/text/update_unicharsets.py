...
def update_unicharset(filepath):
    ...
    targets = [
        ...
        ('"', "10", "16", "Common", "10", "22", "p"),
        ("'", "10", "16", "Common", "10", "27", "p"),
        ("Ꮊ", "5", "1", "Cherokee", "0", "13ba", "A"),
        ("Ꮌ", "5", "1", "Cherokee", "0", "13bc", "A"),
        ("Ꮍ", "5", "1", "Cherokee", "0", "13bd", "A"),
        ("Ꮛ", "5", "1", "Cherokee", "0", "13cb", "A"),
        ("Ᏽ", "5", "1", "Cherokee", "0", "13f5", "x"),
        ("᏶", "5", "1", "Cherokee", "0", "13f6", "x"),
        ("᏷", "5", "1", "Cherokee", "0", "13f7", "x"),
        ("᏾", "5", "1", "Cherokee", "0", "13fe", "x"),
    ]
