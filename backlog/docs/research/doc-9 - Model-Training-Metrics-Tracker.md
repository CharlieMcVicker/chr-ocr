...
- **Current Best Model (Run 20 - June 16)**: The model fine-tuned in the expanded sweep (`run_20_long_const`) is the **new best performing model**, yielding a record low average **7.033% BCER / 15.781% BWER** on the test split. 
